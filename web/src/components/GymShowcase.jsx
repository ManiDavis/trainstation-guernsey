...
const EQUIPMENT = [
  { label: 'Rogue Rig & Racks', icon: '🏋️' },
  { label: 'Colored Bumper Plates', icon: '🔴' },
  { label: 'Air Bikes', icon: '🚴' },
  { label: 'Gymnastics Rings', icon: '⭕' },
  { label: 'Free Weights', icon: '💪' },
  { label: 'Cardio Machines', icon: '🏃' },
  { label: 'Pull-up Bars', icon: '⬆️' },
      ...
      <div className="container">
        <div className="reveal" style={{ display: 'flex', gap: 80, alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          <div style={{ flex: '1 1 340px' }}>
            ...
            <h2 style={{ color: 'var(--white)', marginBottom: 16 }}>Built for<br />Serious Athletes</h2>
            <div className="red-line" />
            <p style={{ marginBottom: 32, color: 'var(--muted-light)' }}>
              Our state-of-the-art facility features premium Rogue equipment throughout — the same brand trusted by elite athletes and CrossFit Games competitors worldwide. Whether you're lifting heavy, doing conditioning work, or training for a specific sport, we have everything you need.
            </p>
            <p style={{ marginBottom: 40, color: 'var(--muted-light)' }}>
              Separate cardio and weightlifting areas mean you can train without distraction. A dedicated space for serious weightlifters downstairs, plus full cardio and functional fitness areas. Plus, our brand-new changing rooms and showers mean you're always ready to go.
            </p>
          ...
          <div className="reveal reveal-delay-2" style={{ flex: '1 1 360px', display: 'grid', gridTemplateColumns: '1fr 1fr', gridTemplateRows: 'auto auto', gap: 12, minHeight: 420 }}>
            ...
            <div style={{
              ...
              <div style={{ position: 'relative', zIndex: 1 }}>
                <div style={{ fontFamily: 'var(--font-display)', fontSize: '2.5rem', fontWeight: 700, color: 'var(--white)', lineHeight: 1 }}>ROGUE</div>
                <div style={{ fontSize: '0.75rem', letterSpacing: '0.15em', color: 'var(--red)', textTransform: 'uppercase', marginTop: 4 }}>Equipment Throughout</div>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ fontFamily: 'var(--font-display)', fontSize: '2.8rem', fontWeight: 700, color: 'var(--white)', lineHeight: 1 }}>2</div>
              <div style={{ fontSize: '0.75rem', letterSpacing: '0.14em', color: 'rgba(255,255,255,0.8)', textTransform: 'uppercase', marginTop: 6 }}>Training<br />Zones</div>
            </div>
